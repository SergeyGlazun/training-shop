...
import up from '../../../../Img/productItemPage/slider/up.png';
import doun from '../../../../Img/productItemPage/slider/doun.png';
import pans from '../../../../Img/productItemPage/slider/pants.png';

import left from '../../../../components/slider/imgButtonLeftRight/prev.svg';
import right from '../../../../components/slider/imgButtonLeftRight/next.svg';
        ...
        <div className='productSection wrapper'>
           ...
           <div className='slidecContener'>
               <div className='tipeItem'>
                   <div className='butTipe'>
                   <img src={up}  alt='imgUser' />
                   <img src={doun}  alt='imgUser' />
                   </div>
                   {
                       arrTipeItem.map(({ id,imageSrc }) =>(
                           <div key={id} >
             ...
             <div className="sliderItem">
                <img  src={left} alt='suit' className='btnleft'/>
                <img  src={right} alt='suit' className='btnright'/>
                <img  src={pans} alt='suit' className='imgItem'/>
             </div>
